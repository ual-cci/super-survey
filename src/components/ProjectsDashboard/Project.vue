...
<section :key="project.name" class="box project">
  <div class="project-title" :class="{ 'click-enabled': surveysLoaded }"
     ...
     <span class="icon is-medium">
       <i v-if="surveysLoaded" class="fas fa-chevron-right" :class="{ visible: !hidden }"></i>
  ...
  <div class="project-content" :class="{ hidden }">
    <div class="sections">
...
export default {
  ...
  computed: {
    ...mapState({
      surveys(state) {
        return state.projects[this.project.id].surveys;
      },
    }),
